        ...
        <div class="center">
            ...
            <div class="c_panner">
                <div @click="levelchange('=|1',$event)" class="c_panner_item" @mouseover="MoveOnCards($event)" @mouseout="MoveOutCards($event)">
                    <span class="c_panner_item_value blue">{{c_top_item_yjsj}}</span>
                ...
                <div @click="levelchange('+=|3',$event)" class="c_panner_item" @mouseover="MoveOnCards($event)" @mouseout="MoveOutCards($event)">
                    <span class="c_panner_item_value ">{{c_top_item_sjsj}}</span>
            ...
            <!--底部各个数值统计-->
            <div class="c_bottom">
                <div @click="showwzss()" class="c_bottom_item">
...
<!--                                </div>-->
        ...
        >
            ...
            <div  class="clearfix" style="background-color: rgb(33 33 33); height: 26px;padding: 9px;">
                <b :style="{color:'#fff',textAlign:'left',}">待督办事件提醒[<c :style="{color:'#f00',}">{{showdbnoreadnum}}</c>/{{showdbnum}}]</b>
                <el-button title="关闭" @click="closeDB" style="float: right; padding: 3px 0;" type="text"><i class="fa fa-times" aria-hidden="true" style="color: #a9aaad;"></i></el-button>
                <el-button title="缩小" v-show="isshowdbmini" @click="miniDB" style="float: right; padding: 3px 0px;margin-right: 15px;" type="text"><i class="fa fa-minus" aria-hidden="true" style="color: #a9aaad;"></i></el-button>
                <el-button title="展开" v-show="isshowdball" @click="openDB"  style="float: right; padding: 3px 0px;margin-right: 15px;" type="text"><i class="fa fa-envelope-open" aria-hidden="true" style="color: #a9aaad;"></i></el-button>

<!--                <hr/>-->
            </div>
            <!--            事件内容 -->
            <div v-show="isshowdbmini" :style="{maxHeight:'250px',overflow: 'auto' , }" class="ddbClass">
                <div v-for="(items,index) in dbdata"
                    ...
                    <div :style="{textAlign:'left',color: 'rgb(202 194 194)',}" >
                        ...
                        </i>【{{orgid.length==3?items.CityName:(orgid.length==6?items.StreetName:items.csName)}}】{{items.ReportTime}}</div>
...
<!--                    :title="items.Description"-->
                    <div style="text-align: left;color: #cab6b6;cursor: pointer;"   @click="showdetails(items.EventID,'镇街大屏-督办')">
                        <w>{{items.Description.length>30?items.Description.substr(0,28)+'...':items.Description }}</w>
                        <w  style="float: right;cursor:pointer;color: #e6a23c;font-size: 15px;" >详情</w>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            //获得镇街中心的账号
            async bindorgcode() {
                // let orgcodedata = await index.fetchData_get(Api.lh.getorgcode, {"id":this.peopleinfologinid});
